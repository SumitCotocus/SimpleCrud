    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="images/logo1.jpg" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" style="background:#fff;color:#000;" href='registration' >Sinup now</a></li>
                    </ul>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3><span class="theme_color">EASILY</span> LEARN ONLINE</h3>
                                        <br>
                                        <h4>LARAVEL AND AJAX<br>ONLY IN ONE MONTHS</h4>
                                        <br>
                                        <p>Showcase your Talent to the world
                                            <br>using online tutorial and Get Hired Faster</p>
                ...
                <div class="col-md-12">
                    <div class="full center">
                        <div class="heading_main text_align_center">
                            ...
                            <p class="large">Lets Develop Your Skills With Laravel And Ajax</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="margin-top_30 col-md-8 offset-md-2 white_fonts">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="full white_fonts text_align_center">
                                <p>sumit.cotocus01@gmail.com
                                    <br>sumit.cotocus01@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="full icon text_align_center">
